...
include_once("conn.php");
     $id = $_GET['id'];
     $row = mysqli_fetch_assoc(mysqli_query($conn,"select * from contact where id='$id'"));
  ?>
    <!doctype html>
<html lang="en">
<head>
...
<form action ="contactupdate.php?id=<?= $row['id'] ?>" method="POST" >
<!-- <div class="mb-3">
...
<div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" value="<?= $row['subject'] ?>" name="txtsubject" class="form-control" >
  </div>
  <div class="mb-3">
    <label for="" class="form-label">Message</label>
    <input type="text" value="<?= $row['message'] ?>" name="txtmessage" class="form-control" >
  </div>
