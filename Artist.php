            ...
            <?php
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-event-area mb-30">
                        ...
                        <img src="./admin/picture/<?php echo $row[1];?>" width="100px"alt="">
                        </div>
                        <div class="event-text">
                            <h4><?php echo $row[7];?></h4>
                            <div class="event-meta-data">
                                <a href="#" class="event-place"><?php echo $row[3]; ?></a>
                                <a href="#" class="event-date"><?php echo $row[4]; ?></a>
                            </div>
                    ...
                    <div class="testimonials-area mb-100 bg-img bg-overlay" style="background-image: url(img/bg-img/bg-3.jpg);">
                        ...
                        <div class="testimonials-slide owl-carousel">
                            ...
                            <div class="single-slide">
                                <p>Post About New Update Concert .</p>
                                <div class="testimonial-info d-flex align-items-center">
                                    <div class="testimonial-thumb">
                                        <img src="img/bg-img/t1.jpg" alt="">
                                    </div>
                                    <p>Admin Sohaib Khan</p>
                                </div>
                            </div>
                            <!-- Single Slide -->
                            <div class="single-slide">
                                <p>New Update About Song.</p>
                                <div class="testimonial-info d-flex align-items-center">
                                    <div class="testimonial-thumb">
                                        <img src="img/bg-img/t1.jpg" alt="">
                                    </div>
                                    <p>Sohaib, Developer</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="testimonials-area mb-100 bg-img bg-overlay" style="background-image: url(img/bg-img/bg-3.jpg);">
                        ...
                        <div class="testimonials-slide owl-carousel">
                            ...
                            <!-- Single Slide -->
                            <div class="single-slide">
                                <p>Bigest Event Of Atif Islam.</p>
                                <div class="testimonial-info d-flex align-items-center">
                                    <div class="testimonial-thumb">
                                        <img src="img/bg-img/t1.jpg" alt="">
                                    </div>
